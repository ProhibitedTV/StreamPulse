...
# Video Games Section
games_label = ttkb.Label(quadrant_frame, text="Video Games", font=("Helvetica", 18, "bold"), bootstyle="primary")
...
science_label = ttkb.Label(quadrant_frame, text="Science & Tech", font=("Helvetica", 18, "bold"), bootstyle="primary")
